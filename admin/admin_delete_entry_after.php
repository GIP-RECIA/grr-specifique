...
<table class="table_adm">
    ...
    <tr>
    <?php echo '<form enctype="multipart/form-data" action="./admin_delete_entry_after.php" id="nom_formulaire" method="post" style="width: 100%;">'.PHP_EOL;
...
?>
	...
	<tr>
		<td>
            Jour de début de la suppression <i>(opération irréversible ! )</i>
		</td>
		<td>
			<?php
            $typeDate = 'beg_';
